...
import { formattedTime, findCardPoint, calculHeuresMinutes } from "../../meteo/js/components/utils/meteoCalcul.js";
Vue.componentExterne('infometeoComponent',{
    props: {
        ma_ville: String,
    },
    data: function() {
  ...
  /*  watch: {
   ...
   created(){
    ...
    template:'infometeoComponent.html'
})